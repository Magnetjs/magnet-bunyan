...
class Bunyan extends _base2.default {
  setup() {
    var _this = this;

    return _asyncToGenerator(function* () {
      const config = Object.assign(_bunyan4.default, _this.config.bunyan, _this.options);
      _this.app.bunyan = _bunyan2.default.createLogger(config);
      _this.app.log = _this.app.bunyan;
    })();
  }
}
